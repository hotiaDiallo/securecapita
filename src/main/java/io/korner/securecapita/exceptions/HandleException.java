package io.korner.securecapita.exceptions;
...
@Slf4j
public class HandleException extends ResponseEntityExceptionHandler implements ErrorController{  // ErrorController to fix whitelabel error
    @Override
